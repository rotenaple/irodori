...
export const ImageWorkspace: React.FC<ImageWorkspaceProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4 w-full h-full min-h-0">
      <div className="flex items-center justify-between pb-3 border-b border-[#333]/5">
        <div className="flex bg-[#EBEBEB] p-1 rounded-xl gap-1">
          <button 
            onClick={() => setActiveTab('original')} 
            className={`px-5 py-2 rounded-lg text-sm font-bold uppercase transition-all ${activeTab === 'original' ? 'bg-white text-[#333] shadow-sm' : 'text-[#333] hover:bg-black/5'}`}
          >
            Draft
          </button>
          <button 
            ...
            className={`px-5 py-2 rounded-lg text-sm font-bold uppercase transition-all ${activeTab === 'processed' ? 'bg-white text-[#333] shadow-sm' : 'text-[#333] hover:bg-black/5 disabled:opacity-30'}`}
          >
            Clean
          </button>
        </div>
        ...
        <div className="flex items-center gap-4">
          <div className="text-right font-mono text-sm leading-tight">
            <div className="text-slate-400 font-bold tracking-tight mb-0.5 text-xs">FILE SIZE</div>
      ...
      <div className="relative flex-1 min-h-[400px] bg-white border border-[#333]/5 rounded-2xl overflow-hidden shadow-inner group">
        {!image ? (
